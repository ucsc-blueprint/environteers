  ...
  return (
    <SafeAreaView style={{ flex: 1 }} edges={['top']}>
      ...
      >
        <ScrollView
          ref={scrollRef}
          style={{ flex: 1, backgroundColor: '#DCE3E8' }}
              ...
              <View style={styles.header}>
                ...
                {typeOfAction === 'in-person' || typeOfAction === 'online' ? (
                  <Text style={styles.headerTitle}>
                    {actionWord} {typeOfAction} eco-action
                  </Text>
                ) : typeOfAction === 'event' ? (
              ...
              <View>
                <View style={styles.photoCard}>
                  {coverPhoto ? (
                    <Pressable onPress={getImage} style={{ width: '100%', height: '100%' }}>
                      <Image source={{ uri: coverPhoto }} style={styles.photo} resizeMode='cover' />
                ...
                <View style={styles.section}>
                  ...
                  <TextInput
                    style={styles.input}
                    placeholder={
                      typeOfAction === 'event' ? 'Enter event title' : 'Enter eco-action title'
                    }
                ...
                {typeOfAction === 'online' && (
                  <View style={styles.section}>
                    <Text style={styles.label}>
                      Campaign Type<Text style={{ color: 'red' }}> *</Text>
                    </Text>
                    <DropDownPicker
                      open={filterOpen}
                      ...
                      <View ref={editorRef}>
                        <RichEditor
                          ...
                          onCursorPosition={(scrollY) => {
                            scrollRef.current?.scrollToPosition(0, scrollY - 30, true);
                          }}
                          style={{ backgroundColor: '#F2F2F2', borderRadius: 12 }}
                          editorStyle={{
                            backgroundColor: '#F2F2F2',
                            contentCSSText: 'font-size: 15px; min-height: 150px;',
                          }}
                        />
                      </View>
                    </>
