        ...
        <View style={styles.modalContainer}>
          ...
          <View>
            <Text style={styles.message}>
              You&apos;re about to approve <Text style={styles.name}>{name}</Text>&apos;s request
              for admin access to the entire application. Ensure that this is the correct individual
              you want to give access to, as admins can edit content freely.
            </Text>
          </View>
